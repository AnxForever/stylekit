...
export const COPY = {
  en: {
    ...
    fieldCardCode: "Card code",
    fieldInputCode: "Input code",
    componentPreviewTitle: "Component preview",
    componentPreviewHint: "Check the colors, fonts and shapes, then try hovering or focusing the samples. Captured animations can be played below; complex page effects may need refinement.",
    componentButton: "Button",
    componentCard: "Card",
    componentInput: "Input",
    componentSample: "A reusable sample kept with your submission.",
    ...
    extractHint:
      "Extract a page's colors, typography and component styles. Review the samples and refine the rules before submitting.",
    extractPlaceholder: "https://example.com",
    extractButton: "Extract",
    extracting: "Extracting...",
    extractProgress: "Reading the page and its component styles. This can take about a minute.",
    extractUndo: "Undo extraction",
    extractSignIn: "Sign in before extracting a website. Your draft will be kept.",
    extractLimited: "You've reached the extraction limit. Try again later.",
    extractUnavailable: "The extractor is unavailable. Try again later or continue editing your draft.",
    extractTimeout: "This page took too long to load. Try a specific content page instead.",
  ...
  zh: {
    ...
    fieldCardCode: "卡片代码",
    fieldInputCode: "输入框代码",
    componentPreviewTitle: "组件预览",
    componentPreviewHint: "投稿前检查配色、字体和形状，再试试悬停或聚焦。已提取的动画可在下方播放，复杂页面动效仍可能需要调整。",
    componentButton: "按钮",
    componentCard: "卡片",
    componentInput: "输入框",
    componentSample: "这个组件样例会随投稿一起保留。",
    ...
    extractHint:
      "提取页面的配色、字体和组件样式。先检查组件预览，再修改规则和投稿信息。",
    extractPlaceholder: "https://example.com",
    extractButton: "提取",
    extracting: "提取中…",
    extractProgress: "正在读取页面与组件样式，可能需要一分钟左右。",
    extractUndo: "撤销本次提取",
    extractSignIn: "请先登录再提取网站，当前草稿会保留。",
    extractLimited: "提取次数已达上限，请稍后再试。",
    extractUnavailable: "提取服务暂不可用，请稍后再试，或继续编辑当前草稿。",
    extractTimeout: "这个页面加载时间过长，可以换成网站内的具体内容页再试。",
