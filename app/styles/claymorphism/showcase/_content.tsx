...
export default function ShowcaseContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-100 via-pink-100 to-purple-100">
      ...
      <ShowcaseHero
        title="Claymorphism"
        description="Soft, playful 3D clay-like design with candy colors, large rounded corners, and combined inner/outer shadows."
      ...
      <ShowcaseSection
        title="Color System"
        subtitle="Soft candy colors with playful gradients"
      ...
      <ShowcaseSection
        title="Buttons"
        subtitle="Soft clay buttons with press effects"
        className="py-16 px-6"
        titleClassName="text-3xl font-bold text-pink-600 mb-4 text-center"
        subtitleClassName="text-pink-500 mb-10 text-center"
      >
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="p-8 bg-gradient-to-br from-white to-pink-50 rounded-[32px] shadow-[12px_12px_24px_rgba(0,0,0,0.1),inset_6px_6px_12px_rgba(255,255,255,0.6),inset_-4px_-4px_8px_rgba(0,0,0,0.05)]">
            <p className="text-sm font-bold text-pink-500 uppercase tracking-wide mb-6">Colors</p>
            ...
            <p className="text-sm font-bold text-pink-500 uppercase tracking-wide mb-6 mt-10">Sizes</p>
      ...
      <ShowcaseSection
        title="Cards"
        subtitle="Soft 3D clay cards with playful icons"
        className="py-16 px-6"
        titleClassName="text-3xl font-bold text-pink-600 mb-4 text-center"
        subtitleClassName="text-pink-500 mb-10 text-center"
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
          <div className="p-6 bg-gradient-to-br from-amber-100 to-amber-200 rounded-[32px] shadow-[12px_12px_24px_rgba(0,0,0,0.1),inset_6px_6px_12px_rgba(255,255,255,0.6),inset_-4px_-4px_8px_rgba(0,0,0,0.05)]">
            ...
            <h3 className="text-xl font-bold text-amber-800 mb-2">Creative</h3>
            <p className="text-amber-700">Playful and fun design for creative projects</p>
          </div>
          ...
          <div className="p-6 bg-gradient-to-br from-green-100 to-green-200 rounded-[32px] shadow-[12px_12px_24px_rgba(0,0,0,0.1),inset_6px_6px_12px_rgba(255,255,255,0.6),inset_-4px_-4px_8px_rgba(0,0,0,0.05)]">
            ...
            <h3 className="text-xl font-bold text-green-800 mb-2">Friendly</h3>
            <p className="text-green-700">Warm and approachable user experience</p>
          </div>
          ...
          <div className="p-6 bg-gradient-to-br from-purple-100 to-purple-200 rounded-[32px] shadow-[12px_12px_24px_rgba(0,0,0,0.1),inset_6px_6px_12px_rgba(255,255,255,0.6),inset_-4px_-4px_8px_rgba(0,0,0,0.05)]">
            ...
            <h3 className="text-xl font-bold text-purple-800 mb-2">Delightful</h3>
            <p className="text-purple-700">Joyful interactions that bring smiles</p>
          </div>
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection
        title="Form Elements"
        subtitle="Soft inset inputs with clay texture"
        className="py-16 px-6"
        titleClassName="text-3xl font-bold text-pink-600 mb-4 text-center"
        subtitleClassName="text-pink-500 mb-10 text-center"
      >
