  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <ShowcaseHero
        ...
        description="Professional, trustworthy, and modern. Perfect for enterprise applications, business dashboards, and corporate websites."
        className="pt-32 pb-20 px-4 md:px-8 bg-gradient-to-b from-white to-slate-50"
        titleClassName="text-4xl md:text-6xl font-bold text-gray-900 mb-6 tracking-tight"
        descriptionClassName="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8"
      >
      ...
      <ShowcaseSection
        title="Color System"
        subtitle="Professional colors that convey trust and reliability."
        className="py-16 px-4 md:px-8 bg-white"
        titleClassName="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
        subtitleClassName="text-gray-600 mb-10"
      >
        <ColorPaletteGrid
          colors={colors}
          cardClassName="rounded-xl overflow-hidden border border-gray-200 shadow-sm"
      ...
      <ShowcaseSection
        title="Buttons"
        subtitle="Clean, accessible buttons with subtle shadows and smooth transitions."
      ...
      <ShowcaseSection
        title="Cards"
        subtitle="Versatile containers with subtle shadows and rounded corners."
        className="py-16 px-4 md:px-8 bg-white"
        titleClassName="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
        subtitleClassName="text-gray-600 mb-10"
      >
      ...
      <ShowcaseSection
        title="Form Elements"
        subtitle="Accessible inputs with clear focus states and validation feedback."
        className="py-16 px-4 md:px-8 bg-slate-50"
        titleClassName="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
        subtitleClassName="text-gray-600 mb-10"
      >
      ...
      <ShowcaseSection
        title="Alerts"
        subtitle="Informative alerts with appropriate color coding."
        className="py-16 px-4 md:px-8 bg-white"
        titleClassName="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
        subtitleClassName="text-gray-600 mb-10"
      >
      ...
      <ShowcaseSection
        ...
        titleClassName="text-3xl md:text-4xl font-bold mb-10"
      >
