---
title: "Scaling a Design System as StyleKit Grew: What We Learned"
...
When StyleKit launched, it had around 30 styles. As the catalog grew, scaling the library by more than 4x proved to be more than a matter of adding entries. Every new style introduced problems we did not anticipate at 30: naming collisions, token inconsistencies, quality variance, discovery friction, and the growing difficulty of checking that every style exposes the same required artifacts. This post shares what we learned and the systems we built to keep the library useful as it grew.
...
At 30 styles, a simple grid works. Scroll through, find something you like, done. As the catalog grew, a grid became overwhelming. Users would scroll through dozens of cards, develop decision fatigue, and either pick whatever caught their eye first or give up and use a style they already knew.
...
StyleKit serves users in English and Chinese, and each style has localized metadata: name, description, do/don't lists, and AI rules. At 30 styles, maintaining two language versions was manageable. As the catalog grew, it became a significant burden. A single update to a style's English do-list meant a corresponding Chinese update, and these frequently fell out of sync.
