...
export function HomeContent({ styles }: HomeContentProps) {
  ...
  const heroStats = [
    ...
    { value: String(coreFeatures.length), label: t("home.coreFeatures") },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-10 sm:py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
            <RevealOnScroll instant>
              ...
              <ul className="mt-3.5 sm:mt-5 grid grid-cols-2 gap-2 sm:gap-2.5 max-w-md" aria-label={t("home.metricAriaLabel")}>
                {heroStats.map((item) => (
                  <li
                    key={item.label}
