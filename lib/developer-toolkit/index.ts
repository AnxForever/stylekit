...
export const developerToolkitManifest = Object.freeze({
  ...
  capabilities: Object.freeze([
    ...
    },
    {
      ...
      evidence: "npm registry latest 1.0.0-beta.3; repository manifest at 1.0.0-beta.4",
    },
    {
      id: "cli",
      state: "public-beta",
      ...
      verifiedAt: "2026-09-12",
      evidence: "npm registry 0.1.4 and repository manifest aligned",
    },
    {
      id: "mcp",
      state: "public-beta",
      ...
      verifiedAt: "2026-09-12",
      evidence: "npm registry 0.2.5 and repository manifest aligned",
    },
    {
      id: "agent-skill",
      state: "public-beta",
