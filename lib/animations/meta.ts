...
export const animationsMeta: AnimationMeta[] = [
  ...
  },
  {
    ...
    name: "边框光束",
    nameEn: "Border Beam",
    description: "一束高光沿元素边框持续环绕巡游，为卡片、按钮或输入框增加科技感的呼吸边界。改编自 border-beam（MIT）。",
    category: "background",
  ...
  },
  {
    ...
    description: "文字像被钢笔一笔一划写出来：SVG 路径配合 stroke-dashoffset 从起笔描到收笔。灵感来自 tegaki（MIT）。",
    category: "text",
  ...
  },
  {
    ...
    description: "荧光笔高亮扫过文字，手绘箭头描出，倾斜的手写标签浮现。批注视觉语言改编自 neat-annotations（MIT）。",
    category: "text",
