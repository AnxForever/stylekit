  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answerZh:
          "StyleKit 提供 130+ 种视觉风格，每种都有 Tailwind 兼容的 design tokens（颜色、间距、圆角、阴影、排版）。你可以将这些 tokens 直接导出到 tailwind.config，作为 AI 提示词用于代码生成，或复制包含 Tailwind 类名的单个组件配方。StyleKit 连接了设计意图与 Tailwind 实现之间的桥梁。",
      },
    ],
  },
];
